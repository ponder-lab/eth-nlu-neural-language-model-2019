...
def train(ckpt, manager, model, optimizer, word2id, id2word):
    '''
    ...
    for epoch in range(EPOCHS):
        ...
        validation_score = validate(model=model, dataset=ds_valid, id2word=id2word, step=optimizer.iterations)
